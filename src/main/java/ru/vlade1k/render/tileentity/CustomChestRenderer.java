package ru.vlade1k.render.tileentity;
...
public class CustomChestRenderer extends TileEntitySpecialRenderer
{

    private static final ResourceLocation field_147505_d = new ResourceLocation(Config.MODID+":textures/blocks/customChestDouble.png");
    private static final ResourceLocation field_147504_g = new ResourceLocation(Config.MODID+":textures/blocks/customChest.png");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    private boolean field_147509_j;
    private static final String __OBFID = "CL_00000965";

    public CustomChestRenderer()
    {
    ...
    public void renderTileEntityAt(TileEntityCustomChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof CustomChest && i == 0)
            {
                try
                {
                    ((CustomChest)block).func_149954_e(p_147500_1_.getWorldObj(), p_147500_1_.xCoord, p_147500_1_.yCoord, p_147500_1_.zCoord);
                }
    ...
    {
        this.renderTileEntityAt((TileEntityCustomChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}